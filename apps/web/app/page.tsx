  ...
  return (
    <div className="min-h-screen gradient-mesh relative overflow-hidden">
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6">
        <div className="max-w-md text-center space-y-10 animate-fade-up">
          {/* Logo/Icon */}
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl font-display italic tracking-tight text-foreground">
              Health Tracker
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Log meals, workouts, weight, and questions in one natural sentence.
              Your health history now reads like a conversation.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-4">
            {[
              { icon: Mic, label: "Natural Language" },
              { icon: Utensils, label: "Conversation Feed" },
              { icon: Dumbbell, label: "Smart Prompts" },
              { icon: Activity, label: "Glanceable Metrics" },
            ].map((feature) => (
              <span
                key={feature.label}
